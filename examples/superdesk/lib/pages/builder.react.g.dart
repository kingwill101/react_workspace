...
JSObject _BuilderPage_toJS(
  ({
    String lessonName,
    dynamic Function(String) onLessonName,
    dynamic Function(List<Map<String, dynamic>>) onPhases,
...
_BuilderPage_fromJS(JSObject js) {
  final lessonName = requiredJSString(
    js,
    "lessonName",
    component: "BuilderPage",
  );
  final dynamic Function(String) onLessonName = (String param0) {
    final _fn = js.getProperty('onLessonName'.toJS) as JSFunction;
  ...
  final dynamic Function(List<Map<String, dynamic>>) onPhases =
      (List<Map<String, dynamic>> param0) {
        final _fn = js.getProperty('onPhases'.toJS) as JSFunction;
        final rawResult = invokeJSCallback(_fn, <JSAny?>[
          encodeReactValue((
            kind: ReactValueKind.encodedObject,
            nullable: false,
  ...
  final phases =
      js.getProperty("phases".toJS).dartify() as List<Map<String, dynamic>>;
  final resources =
