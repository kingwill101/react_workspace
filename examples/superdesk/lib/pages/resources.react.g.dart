...
JSObject _ResourcesPage_toJS(
  ({
    ...
    dynamic Function(Map<String, dynamic>) onDelete,
    dynamic Function(Map<String, dynamic>) onDuplicate,
    dynamic Function(Map<String, dynamic>) onEdit,
    dynamic Function(String) onFilter,
...
_ResourcesPage_fromJS(JSObject js) {
  ...
  final dynamic Function(Map<String, dynamic>) onDelete =
      (Map<String, dynamic> param0) {
        final _fn = js.getProperty('onDelete'.toJS) as JSFunction;
        final rawResult = invokeJSCallback(_fn, <JSAny?>[
          encodeReactValue((
            kind: ReactValueKind.encodedObject,
            nullable: false,
  ...
  final dynamic Function(Map<String, dynamic>) onDuplicate =
      (Map<String, dynamic> param0) {
        final _fn = js.getProperty('onDuplicate'.toJS) as JSFunction;
        final rawResult = invokeJSCallback(_fn, <JSAny?>[
          encodeReactValue((
            kind: ReactValueKind.encodedObject,
            nullable: false,
  ...
  final dynamic Function(Map<String, dynamic>) onEdit =
      (Map<String, dynamic> param0) {
        final _fn = js.getProperty('onEdit'.toJS) as JSFunction;
        final rawResult = invokeJSCallback(_fn, <JSAny?>[
          encodeReactValue((
            kind: ReactValueKind.encodedObject,
            nullable: false,
  ...
  final dynamic Function(String) onFilter = (String param0) {
    final _fn = js.getProperty('onFilter'.toJS) as JSFunction;
    final rawResult = invokeJSCallback(_fn, <JSAny?>[
  ...
  final dynamic Function(String) onSearch = (String param0) {
    final _fn = js.getProperty('onSearch'.toJS) as JSFunction;
    final rawResult = invokeJSCallback(_fn, <JSAny?>[
      encodeReactValue(reactString, param0),
    ]);
    return decodeReactValue((
  ...
  final resources =
      js.getProperty("resources".toJS).dartify() as List<Map<String, dynamic>>;
