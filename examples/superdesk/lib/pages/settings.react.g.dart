...
JSObject _SettingsPage_toJS(({dynamic Function() onExport, dynamic Function(String) onImport, dynamic Function() onLogout, dynamic Function() onReset, dynamic Function(String) onToast, Map<String, dynamic>? user}) props) {
  final o = JSObject();
  o.setProperty('onExport'.toJS, callbackToJS(ReactCallback(
  ...
  o.setProperty('onImport'.toJS, callbackToJS(ReactCallback(
...
({dynamic Function() onExport, dynamic Function(String) onImport, dynamic Function() onLogout, dynamic Function() onReset, dynamic Function(String) onToast, Map<String, dynamic>? user}) _SettingsPage_fromJS(JSObject js) {
...
final dynamic Function(String) onImport =
    (String param0) {
      final _fn = js.getProperty(
        'onImport'.toJS,
      ) as JSFunction;
...
final user = js.getProperty("user".toJS).dartify() as Map<String, dynamic>?;
  return (onExport: onExport, onImport: onImport, onLogout: onLogout, onReset: onReset, onToast: onToast, user: user);
}
...
void registerSettingsPage(){
  ReactRegistry.register(idSettingsPage.value, $SettingsPage,
      toJS: (p) => _SettingsPage_toJS(p as ({dynamic Function() onExport, dynamic Function(String) onImport, dynamic Function() onLogout, dynamic Function() onReset, dynamic Function(String) onToast, Map<String, dynamic>? user})),
