...
import 'package:react_web/web.dart' show HTMLInputElement, FileReader, Event, Blob;
          ...
          div(
            ...
            children: [
              button(
                ...
                className: 'w-full h-[44px] bg-cream border-3 border-dark rounded-full font-black text-[13px] hover:bg-[#ffe8a3] transition-colors',
                children: [Text('📥 Export Settings JSON')],
              ),
              label(
                className: 'w-full h-[44px] bg-cream border-3 border-dark rounded-full font-black text-[13px] hover:bg-[#c8f5d4] transition-colors flex items-center justify-center cursor-pointer',
                children: [
