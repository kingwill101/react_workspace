...
const idResourcesPage = ComponentId('package:superdesk/lib/pages/resources.dart#ResourcesPage');
...
ReactNode ResourcesPage({
  ...
  final props = (filter: filter, onAdd: onAdd, onDelete: onDelete, onDuplicate: onDuplicate, onEdit: onEdit, onFilter: onFilter, onSearch: onSearch, onToast: onToast, resources: resources, search: search);
