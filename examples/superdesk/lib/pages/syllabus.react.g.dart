...
_SyllabusPage_fromJS(JSObject js) {
  final classes =
      js.getProperty("classes".toJS).dartify() as List<Map<String, dynamic>>;
  final expandedUnits =
      js.getProperty("expandedUnits".toJS).dartify() as List<String>;
  final dynamic Function(String) onSelect = (String param0) {
    final _fn = js.getProperty('onSelect'.toJS) as JSFunction;
  ...
  final dynamic Function(String) onToggle = (String param0) {
    final _fn = js.getProperty('onToggle'.toJS) as JSFunction;
    final rawResult = invokeJSCallback(_fn, <JSAny?>[
      encodeReactValue(reactString, param0),
    ]);
    return decodeReactValue((
  ...
  final selectedSyllabus = requiredJSString(
    js,
    "selectedSyllabus",
...
void registerSyllabusPage() {
  ReactRegistry.register(
    idSyllabusPage.value,
    $SyllabusPage,
    toJS: (p) => _SyllabusPage_toJS(
      p
          as ({
            List<Map<String, dynamic>> classes,
            List<String> expandedUnits,
