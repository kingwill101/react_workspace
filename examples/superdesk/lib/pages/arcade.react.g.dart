...
JSObject _ArcadePage_toJS(
  ({
    String arcadeGame,
    dynamic Function(String) onGame,
    dynamic Function(int) onScore,
    dynamic Function(String) onToast,
    dynamic Function(bool) onWordPop,
    int score,
    bool wordPopActive,
  })
  props,
...
_ArcadePage_fromJS(JSObject js) {
  final arcadeGame = requiredJSString(
    js,
    "arcadeGame",
    component: "ArcadePage",
  );
  final dynamic Function(String) onGame = (String param0) {
    final _fn = js.getProperty('onGame'.toJS) as JSFunction;
  ...
  final dynamic Function(int) onScore = (int param0) {
    final _fn = js.getProperty('onScore'.toJS) as JSFunction;
    final rawResult = invokeJSCallback(_fn, <JSAny?>[
  ...
  final dynamic Function(bool) onWordPop = (bool param0) {
    final _fn = js.getProperty('onWordPop'.toJS) as JSFunction;
    final rawResult = invokeJSCallback(_fn, <JSAny?>[
  ...
  final wordPopActive = requiredJSBool(
    js,
    "wordPopActive",
    component: "ArcadePage",
  );
