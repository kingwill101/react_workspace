...
JSObject _LiveBoardPage_toJS(
  ({
    String liveCode,
    int liveJoined,
    dynamic Function() onJoin,
...
void registerLiveBoardPage() {
  ReactRegistry.register(
    idLiveBoardPage.value,
    $LiveBoardPage,
    toJS: (p) => _LiveBoardPage_toJS(
      p
          as ({
            String liveCode,
            int liveJoined,
