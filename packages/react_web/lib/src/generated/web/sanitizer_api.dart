...
final class SanitizerAttributeNamespaceValue implements SanitizerAttributeNamespace {
  @override
  String name;
  @override
  String? namespace;

  SanitizerAttributeNamespaceValue({
    required this.name,
    this.namespace,
  });
}
...
final class SanitizerElementNamespaceValue implements SanitizerElementNamespace {
  @override
  String name;
  @override
  String? namespace;

  SanitizerElementNamespaceValue({
    required this.name,
    this.namespace,
  });
}
...
final class SanitizerElementNamespaceWithAttributesValue implements SanitizerElementNamespaceWithAttributes {
  @override
  List<SanitizerAttribute>? attributes;
  @override
  List<SanitizerAttribute>? removeAttributes;
