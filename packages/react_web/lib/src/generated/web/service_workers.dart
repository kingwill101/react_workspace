...
final class ClientQueryOptionsValue implements ClientQueryOptions {
  ...
  ClientQueryOptionsValue({this.includeUncontrolled, this.type_});
}
...
abstract interface class ExtendableEvent {
  factory ExtendableEvent(String type_, [ExtendableEventInit? eventInitDict]) =>
      WebRuntime.current.createWebObject<ExtendableEvent>('ExtendableEvent', [
        type_,
        eventInitDict,
      ]);
...
final class ExtendableMessageEventInitValue
    implements ExtendableMessageEventInit {
  @override
  Object? data;
  @override
  String? origin;
...
abstract interface class FetchEvent {
  factory FetchEvent(String type_, FetchEventInit eventInitDict) => WebRuntime
      .current
      .createWebObject<FetchEvent>('FetchEvent', [type_, eventInitDict]);
  Request get request;
...
final class MultiCacheQueryOptionsValue implements MultiCacheQueryOptions {
  ...
  MultiCacheQueryOptionsValue({this.cacheName});
}
...
final class NavigationPreloadStateValue implements NavigationPreloadState {
  ...
  NavigationPreloadStateValue({this.enabled, this.headerValue});
}
...
final class RegistrationOptionsValue implements RegistrationOptions {
  ...
  RegistrationOptionsValue({this.scope, this.type_, this.updateViaCache});
}
...
final class RouterRuleValue implements RouterRule {
  ...
  RouterRuleValue({required this.condition, required this.source});
}
...
final class RouterSourceDictValue implements RouterSourceDict {
  ...
  RouterSourceDictValue({this.cacheName});
}
