...
abstract interface class CSSKeywordValue {
  factory CSSKeywordValue(String value) => WebRuntime.current
      .createWebObject<CSSKeywordValue>('CSSKeywordValue', [value]);
  String get value;
...
abstract interface class CSSMathClamp {
  factory CSSMathClamp(
    ...
    CSSNumberish value,
    CSSNumberish upper,
  ) => WebRuntime.current.createWebObject<CSSMathClamp>('CSSMathClamp', [
    lower,
    value,
    upper,
  ]);
...
abstract interface class CSSMathInvert {
  factory CSSMathInvert(CSSNumberish arg) =>
      WebRuntime.current.createWebObject<CSSMathInvert>('CSSMathInvert', [arg]);
  CSSNumericValue get value;
}

abstract interface class CSSMathMax {
  factory CSSMathMax([List<CSSNumberish>? args]) =>
      WebRuntime.current.createWebObject<CSSMathMax>('CSSMathMax', [args]);
  CSSNumericArray get values;
}

abstract interface class CSSMathMin {
  factory CSSMathMin([List<CSSNumberish>? args]) =>
      WebRuntime.current.createWebObject<CSSMathMin>('CSSMathMin', [args]);
  CSSNumericArray get values;
}

abstract interface class CSSMathNegate {
  factory CSSMathNegate(CSSNumberish arg) =>
      WebRuntime.current.createWebObject<CSSMathNegate>('CSSMathNegate', [arg]);
  CSSNumericValue get value;
}
...
abstract interface class CSSMathProduct {
  factory CSSMathProduct([List<CSSNumberish>? args]) => WebRuntime.current
      .createWebObject<CSSMathProduct>('CSSMathProduct', [args]);
  CSSNumericArray get values;
}

abstract interface class CSSMathSum {
  factory CSSMathSum([List<CSSNumberish>? args]) =>
      WebRuntime.current.createWebObject<CSSMathSum>('CSSMathSum', [args]);
  CSSNumericArray get values;
}
...
final class CSSMatrixComponentOptionsValue
    implements CSSMatrixComponentOptions {
  @override
  bool? is2D;

  CSSMatrixComponentOptionsValue({this.is2D});
}
...
abstract interface class CSSPerspective {
  factory CSSPerspective(CSSPerspectiveValue length) => WebRuntime.current
      .createWebObject<CSSPerspective>('CSSPerspective', [length]);
...
abstract interface class CSSRotate {
  factory CSSRotate(CSSNumericValue angle) =>
      WebRuntime.current.createWebObject<CSSRotate>('CSSRotate', [angle]);
  factory CSSRotate.named1(
    CSSNumberish x,
    CSSNumberish y,
    CSSNumberish z,
    CSSNumericValue angle,
  ) => WebRuntime.current.createWebObject<CSSRotate>('CSSRotate', [
    x,
    y,
    z,
    angle,
...
abstract interface class CSSScale {
  factory CSSScale(CSSNumberish x, CSSNumberish y, [CSSNumberish? z]) =>
      WebRuntime.current.createWebObject<CSSScale>('CSSScale', [x, y, z]);
  CSSNumberish get x;
  set x(CSSNumberish value);
  CSSNumberish get y;
  set y(CSSNumberish value);
...
abstract interface class CSSSkew {
  factory CSSSkew(CSSNumericValue ax, CSSNumericValue ay) =>
      WebRuntime.current.createWebObject<CSSSkew>('CSSSkew', [ax, ay]);
...
abstract interface class CSSSkewX {
  factory CSSSkewX(CSSNumericValue ax) =>
      WebRuntime.current.createWebObject<CSSSkewX>('CSSSkewX', [ax]);
  CSSNumericValue get ax;
  set ax(CSSNumericValue value);
}
...
abstract interface class CSSSkewY {
  factory CSSSkewY(CSSNumericValue ay) =>
      WebRuntime.current.createWebObject<CSSSkewY>('CSSSkewY', [ay]);
  CSSNumericValue get ay;
  set ay(CSSNumericValue value);
}
...
abstract interface class CSSTranslate {
  factory CSSTranslate(
    ...
    CSSNumericValue y, [
    CSSNumericValue? z,
  ]) => WebRuntime.current.createWebObject<CSSTranslate>('CSSTranslate', [
    x,
    y,
    z,
  ]);
...
abstract interface class CSSUnitValue {
  factory CSSUnitValue(double value, String unit) => WebRuntime.current
      .createWebObject<CSSUnitValue>('CSSUnitValue', [value, unit]);
  double get value;
...
abstract interface class CSSUnparsedValue {
  factory CSSUnparsedValue(List<CSSUnparsedSegment> members) => WebRuntime
      .current
      .createWebObject<CSSUnparsedValue>('CSSUnparsedValue', [members]);
  int get length;
}
