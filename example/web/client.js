...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _App_fromJS(js) {
      return new A._Record_1_title(A._asString(A.getProperty(js, "title", type$.Object)));
    },
    registerApp() {
      return A.ReactRegistry_register(string$.packag, $.$get$$App());
    },
    ...
    _Avatar_fromJS(js) {
      var t1 = type$.Object;
      return new A._Record_2_size_src(A._asInt(A.getProperty(js, "size", t1)), A._asString(A.getProperty(js, "src", t1)));
    },
    registerAvatar() {
      return A.ReactRegistry_register("package:react_workspace/example/lib/avatar.dart#Avatar", $.$get$$Avatar());
    },
    ...
    _Badge_fromJS(js) {
      return new A._Record_1_label(A._asString(A.getProperty(js, "label", type$.Object)));
    },
    registerBadge() {
      return A.ReactRegistry_register("package:react_workspace/example/lib/badge.dart#Badge", $.$get$$Badge());
    },
    ...
    Intrinsic$(tag, children, key, props) {
      return new A.Intrinsic(tag, props, children, key);
    },
    Component$(id, props, children, key, $P) {
      return new A.Component(id, props, key, children, $P._eval$1("Component<0>"));
    },
    Text$(value) {
    ...
    Intrinsic: function Intrinsic(t0, t1, t2, t3) {
      var _ = this;
      _.tag = t0;
      _.props = t1;
      _.children = t2;
    ...
    mount(root, node, mode) {
      var t1, t2, t3;
      $label0$0: {
        t1 = A._callMethodUnchecked1(A._getPropertyTrustType(A.staticInteropGlobalContext(), "ReactDOM", type$.Object), "createRoot", root, type$.JSObject);
        t2 = A.StringToJSString_get_toJS("render");
        t3 = A.ReactInternal_renderer().render$1(node);
        if (t3 == null)
          t3 = A._asObject(t3);
        t3 = A.JSObjectUnsafeUtilExtension_callMethod(t1, t2, t3, null, null, type$.nullable_Object);
        t1 = t3;
        break $label0$0;
      }
      return t1;
    },
    MountMode: function MountMode() {
    },
    ...
    ReactRegistry_register(id, fn) {
      J.$indexSet$ax($.ReactRegistry__map, id, fn);
      return fn;
    },
    ReactRegistry_lookup(id) {
      return J.$index$ax($.ReactRegistry__map, id);
    },
    ...
    _AppProps(title) {
      ...
      A.JSObjectUnsafeUtilExtension_setProperty(o, A.StringToJSString_get_toJS("title"), A.StringToJSString_get_toJS(title));
      return o;
    },
    App(children, key, title) {
      return A.Component$(string$.packag, A._AppProps(title), children, key, type$.JSObject);
    },
    Avatar(props) {
    ...
    main() {
      A.ReactInternal_init(A.JsBinding$(), A.JsRenderer$());
      A.registerApp();
      A.registerAvatar();
      A.registerBadge();
      var root = A._callMethodUnchecked1(A._getPropertyTrustType(A.staticInteropGlobalContext(), "document", type$.Object), "getElementById", "app", type$.nullable_JSObject);
      if (root != null)
        A.mount(root, A.App(B.List_empty, "root", "hi"), B.C_Attach);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.$App_closure_wrapper.prototype = {
    call$1(p) {
      var tree = A.App0(A._App_fromJS(A._asJSObject(p)));
      return A._asJSObject(A.ReactInternal_renderer().render$1(tree));
    },
    $signature: 1
  };
  ...
  A.$Avatar_closure_wrapper.prototype = {
    call$1(p) {
      var tree = A.Avatar(A._Avatar_fromJS(A._asJSObject(p)));
      return A._asJSObject(A.ReactInternal_renderer().render$1(tree));
    },
    $signature: 1
  };
  ...
  A.$Badge_closure_wrapper.prototype = {
    call$1(p) {
      var tree = A.Badge(A._Badge_fromJS(A._asJSObject(p)));
      return A._asJSObject(A.ReactInternal_renderer().render$1(tree));
    },
    $signature: 1
  };
  ...
  A.JsRenderer.prototype = {
    ...
    _render$1(n) {
      ...
      $label0$0: {
        ...
        if (n instanceof A.Intrinsic) {
          t1 = A.JSObjectUnsafeUtilExtension_callMethod(A.getProperty(A.staticInteropGlobalContext(), "React", type$.JSObject), A.StringToJSString_get_toJS(_s13_), A.StringToJSString_get_toJS(n.tag), _this._withKey$2(_this._propsToJS$1(n.props), n.key), _this._childrenToJS$1(n.children), type$.nullable_Object);
          break $label0$0;
        }
        if (n instanceof A.Component) {
          t1 = A.getProperty(A.staticInteropGlobalContext(), "React", type$.JSObject);
          t2 = A.StringToJSString_get_toJS(_s13_);
          t3 = A.ReactRegistry_lookup(n.id);
          if (t3 == null)
            t3 = A._asObject(t3);
          t3 = A.JSObjectUnsafeUtilExtension_callMethod(t1, t2, t3, _this._withKey$2(_this._toJSObject$1(n.props), n.key), _this._childrenToJS$1(n.children), type$.nullable_Object);
          t1 = t3;
          break $label0$0;
        }
    ...
    _toJSObject$1(p) {
      if (p == null)
        return A.JSObject_constructor_();
      if (type$.JSObject._is(p))
        return p;
      return A.JSObject_constructor_();
    },
    _withKey$2(o, k) {
      ...
      A._asStringQ(k);
      if (k != null)
        A.JSObjectUnsafeUtilExtension_setProperty(o, A.StringToJSString_get_toJS("key"), A.StringToJSString_get_toJS(k));
      return o;
    },
    _childrenToJS$1(children) {
      var t1 = type$.Object;
      return A.ListToJSArray_get_toJS(J.toList$0$ax(J.whereType$1$0$ax(J.map$1$1$ax(type$.List_ReactNode._as(children), this.get$_render(), type$.nullable_Object), t1)), t1);
    }
  };
  A.JsRenderer__propsToJS_closure.prototype = {
    call$2(k, v) {
      A._asString(k);
      if (v != null)
        A.JSObjectUnsafeUtilExtension_setProperty(this.o, A.StringToJSString_get_toJS(k), v);
    },
    $signature: 7
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(A.JsRenderer.prototype, "get$_render", "_render$1", 6);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.$App_closure_wrapper, A.$Avatar_closure_wrapper, A.$Badge_closure_wrapper]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A.JsLinkedHashMap, A.MapBase);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.MapBase_mapToString_closure, A.JsRenderer__propsToJS_closure]);
    ...
    _inheritMany(A.Closure0Args, [A.$App_closure, A.$Avatar_closure, A.$Badge_closure]);
    _inheritMany(A.ReactNode, [A.Intrinsic, A.Component, A.Text]);
    _inherit(A.Attach, A.MountMode);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["JavaScriptFunction()", "JSObject(JSObject)", "@(@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "Object?(ReactNode)", "~(String,Object?)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      List_ReactNode: findType("List<ReactNode>"),
...
;
  ...
  (function staticFields() {
    ...
    $.ReactRegistry__map = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.JavaScriptFunction);
  })();
