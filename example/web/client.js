...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Entry$(comp, toJS, fromJS) {
      return new A._Entry(comp, toJS);
    },
    ReactRegistry_register(id, c, fromJS, toJS) {
      J.$indexSet$ax($.ReactRegistry__m, id, A._Entry$(c, toJS, fromJS));
    },
    ReactRegistry_lookup(id) {
      return J.$index$ax($.ReactRegistry__m, id);
    },
    _Entry: function _Entry(t0, t1) {
      this.comp = t0;
      this.toJS = t1;
    },
    JsRenderer$() {
...
;
  ...
  (function staticFields() {
    ...
    $.ReactRegistry__m = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, A.findType("_Entry"));
  })();
