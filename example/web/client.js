...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _unwrapNonDartException(ex) {
      ...
      if (ex instanceof RangeError) {
        ...
        return A.saveStackTrace(ex, A.ArgumentError$(typeof message == "string" ? message.replace(/^RangeError:\s*/, "") : message));
      }
    ...
    _Record_1_label: function _Record_1_label(t0) {
      this._0 = t0;
    },
    ...
    _Record_2_size_src: function _Record_2_size_src(t0, t1) {
      this._0 = t0;
      this._1 = t1;
    },
    _Record_4_initialCount_onChange_subtitle_title: function _Record_4_initialCount_onChange_subtitle_title(t0) {
      this._values = t0;
    },
    ...
    App0(props) {
      var t1 = props._0;
      return A.div(A._setArrayType([A.Badge0(t1), A.Avatar0(48, "user.png"), A.Counter0(0, new A.App_closure(), "from App", t1)], type$.JSArray_ReactNode));
    },
    ...
    registerApp() {
      A.ReactRegistry_register(string$.packagap, $.$get$$App(), new A.registerApp_closure(), new A.registerApp_closure0());
    },
    $App_closure: function $App_closure() {
    },
    ...
    _Avatar_toJS(props) {
      var o = A.JSObject_constructor_();
      A.JSObjectUnsafeUtilExtension_setProperty(o, A.StringToJSString_get_toJS("size"), A.NumToJSExtension_get_toJS(props._0));
      A.JSObjectUnsafeUtilExtension_setProperty(o, A.StringToJSString_get_toJS("src"), A.StringToJSString_get_toJS(props._1));
      return o;
    },
    _Avatar_fromJS(js) {
      return new A._Record_2_size_src(A.requiredJSInt(js, "size", "size"), A.requiredJSString(js, "src", "src"));
    },
    registerAvatar() {
      A.ReactRegistry_register(string$.packagav, $.$get$$Avatar(), new A.registerAvatar_closure(), new A.registerAvatar_closure0());
    },
    $Avatar_closure: function $Avatar_closure() {
    },
    $Avatar_closure_wrapper: function $Avatar_closure_wrapper() {
    },
    registerAvatar_closure0: function registerAvatar_closure0() {
    },
    registerAvatar_closure: function registerAvatar_closure() {
    },
    _Badge_toJS(props) {
      var o = A.JSObject_constructor_();
      A.JSObjectUnsafeUtilExtension_setProperty(o, A.StringToJSString_get_toJS("label"), A.StringToJSString_get_toJS(props._0));
      return o;
    },
    _Badge_fromJS(js) {
      return new A._Record_1_label(A.requiredJSString(js, "label", "label"));
    },
    registerBadge() {
      A.ReactRegistry_register(string$.packagb, $.$get$$Badge(), new A.registerBadge_closure(), new A.registerBadge_closure0());
    },
    $Badge_closure: function $Badge_closure() {
    },
    $Badge_closure_wrapper: function $Badge_closure_wrapper() {
    },
    registerBadge_closure0: function registerBadge_closure0() {
    },
    registerBadge_closure: function registerBadge_closure() {
    },
    Counter(props) {
      var _1_0, other, inc, t3, sub, t1 = {},
        t2 = props._values,
        _0_0 = A.useState(t2[0], type$.int),
        count = _0_0._0;
      _0_0._1;
      t1.setOther = null;
      _1_0 = A.useState(false, type$.bool);
      other = _1_0._0;
      t1.setOther = _1_0._1;
      A.useEffect(new A.Counter_closure(t1), []);
      t1 = type$.JSArray_ReactNode;
      inc = A.Intrinsic$("button", A._setArrayType([A.Text$("+1")], t1), null, B.Map_empty);
      t3 = t2[2];
      sub = t3 != null ? A.Text$(t3) : null;
      t1 = A._setArrayType([A.Text$(t2[3]), A.Text$("Count: " + A.S(count)), inc], t1);
      if (sub != null)
        t1.push(sub);
      t1.push(A.Text$(other ? "effect:ran" : "effect:pending"));
      return A.div(t1);
    },
    Counter_closure: function Counter_closure(t0) {
      this._box_0 = t0;
    },
    _Counter_toJS(props) {
      var t3,
        o = A.JSObject_constructor_(),
        t1 = A.StringToJSString_get_toJS("initialCount"),
        t2 = props._values;
      A.JSObjectUnsafeUtilExtension_setProperty(o, t1, A.NumToJSExtension_get_toJS(t2[0]));
      t1 = A.StringToJSString_get_toJS("onChange");
      A.JSObjectUnsafeUtilExtension_setProperty(o, t1, t2[1] == null ? null : A._functionToJS1(new A._Counter_toJS_closure(props)));
      if (t2[2] != null) {
        t1 = A.StringToJSString_get_toJS("subtitle");
        t3 = t2[2];
        t3.toString;
        A.JSObjectUnsafeUtilExtension_setProperty(o, t1, A.StringToJSString_get_toJS(t3));
      }
      A.JSObjectUnsafeUtilExtension_setProperty(o, A.StringToJSString_get_toJS("title"), A.StringToJSString_get_toJS(t2[3]));
      return o;
    },
    _Counter_fromJS(js) {
      var _s12_ = "initialCount";
      return new A._Record_4_initialCount_onChange_subtitle_title([A.requiredJSInt(js, _s12_, _s12_), new A._Counter_fromJS_closure(js), A.nullableJSString(js, "subtitle"), A.requiredJSString(js, "title", "title")]);
    },
    registerCounter() {
      A.ReactRegistry_register(string$.packagc, $.$get$$Counter(), new A.registerCounter_closure(), new A.registerCounter_closure0());
    },
    _Counter_toJS_closure: function _Counter_toJS_closure(t0) {
      this.props = t0;
    },
    _Counter_fromJS_closure: function _Counter_fromJS_closure(t0) {
      this.js = t0;
    },
    $Counter_closure: function $Counter_closure() {
    },
    $Counter_closure_wrapper: function $Counter_closure_wrapper() {
    },
    registerCounter_closure0: function registerCounter_closure0() {
    },
    registerCounter_closure: function registerCounter_closure() {
    },
    ReactInternal_binding() {
      return $.ReactInternal___binding.readField$1$0(type$.ReactBinding);
    },
    ReactInternal_binding0(value) {
    ...
    ReactInternal_init(binding, renderer) {
      A.ReactInternal_binding0(binding);
    ...
    JsBinding_useState_closure: function JsBinding_useState_closure(t0, t1) {
      this.setter = t0;
      this.T = t1;
    },
    JsBinding_useEffect_closure: function JsBinding_useEffect_closure() {
    },
    toReactJS(v) {
      var t1;
      $label0$0: {
    ...
    nullableJSString(o, key) {
      var raw = A.JSObjectUnsafeUtilExtension_getProperty(o, A.StringToJSString_get_toJS(key), type$.nullable_Object);
      return raw == null || A.NullableUndefineableJSAnyExtension_get_isUndefined(raw) ? null : A.JSStringToString_get_toDart(A._asString(raw));
    },
    fromJS(js, $T) {
      if (J.$eq$(A.createRuntimeType($T), B.Type_String_AXU))
        return $T._as(A.JSStringToString_get_toDart(A._asString(js)));
      if (J.$eq$(A.createRuntimeType($T), B.Type_int_T7V))
        return $T._as(A.JSNumberToNumber_get_toDartInt(A._asDouble(js)));
      if (J.$eq$(A.createRuntimeType($T), B.Type_double_JIQ))
        return $T._as(A.JSNumberToNumber_get_toDartDouble(A._asDouble(js)));
      if (J.$eq$(A.createRuntimeType($T), B.Type_bool_wF1))
        return $T._as(A.JSBooleanToBool_get_toDart(A._asBool(js)));
      if (J.$eq$(A.createRuntimeType($T), B.Type_num_LZa))
        return $T._as(A.JSNumberToNumber_get_toDartDouble(A._asDouble(js)));
      return $T._as(js);
    },
    _mapToJS(m) {
    ...
    JSNumberToNumber_get_toDartDouble(_this) {
      return A.JSNumberTypeExtension_get_self(_this);
    },
    ...
    JSNumberTypeExtension_get_self(_this) {
      return _this;
    },
    ...
    App(title) {
      return A.Component$(string$.packagap, new A._Record_1_title(title), B.List_empty, null, type$.Record_1_String_title);
    },
    Avatar(props) {
      return A.Text$(A.S(props._1) + ":" + A.S(props._0));
    },
    Avatar0(size, src) {
      return A.Component$(string$.packagav, new A._Record_2_size_src(size, src), B.List_empty, null, type$.Record_2_int_size_and_String_src);
    },
    Badge(props) {
      return A.div(A._setArrayType([A.Text$(props._0)], type$.JSArray_ReactNode));
    },
    Badge0(label) {
      return A.Component$(string$.packagb, new A._Record_1_label(label), B.List_empty, null, type$.Record_1_String_label);
    },
    Counter0(initialCount, onChange, subtitle, title) {
      return A.Component$(string$.packagc, new A._Record_4_initialCount_onChange_subtitle_title([initialCount, onChange, subtitle, title]), B.List_empty, null, type$.Record_4_int_initialCount_and_nullable_void_Function_int_onChange_and_nullable_String_subtitle_and_String_title);
    },
    ...
    useState(initial, $T) {
      return A.ReactInternal_binding().useState$1$1(initial, $T);
    },
    useEffect(e, deps) {
      return A.ReactInternal_binding().useEffect$2(e, deps);
    },
    div(children) {
    ...
    getInitialProps() {
      var txt, t1,
        el = A._callMethodUnchecked1(A._getPropertyTrustType(A.staticInteropGlobalContext(), "document", type$.Object), "getElementById", "__props", type$.nullable_JSObject);
      if (el == null)
        return A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      txt = A._asString(A.JSObjectUnsafeUtilExtension_getProperty(el, A.StringToJSString_get_toJS("textContent"), type$.nullable_Object));
      if (B.JSString_methods.get$isEmpty(J.trim$0$s(A.JSStringToString_get_toDart(txt))))
        return A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      t1 = type$.nullable_Map_String_dynamic._as(A.jsonDecode(A.JSStringToString_get_toDart(txt)));
    ...
    hydrate(root, node) {
      var t1 = A._getPropertyTrustType(A.staticInteropGlobalContext(), "ReactDOM", type$.Object),
        t2 = A.ReactInternal_renderer().render$1(node);
      if (t2 == null)
        t2 = A._asObject(t2);
      return A._callMethodUnchecked2(t1, "hydrateRoot", root, t2, type$.void);
    },
    main() {
      var root, props;
      A.initReact();
      A.registerReactComponents();
      root = A.getRoot("app");
      props = A.getInitialProps();
      if (props.get$isNotEmpty(props))
        A.hydrate(root, A.App(A._asString(props.$index(0, "title"))));
      else
        A.mount(root, A.App("Hello from React"));
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A._Record_1_label.prototype = {$recipe: "+label(1)", $shape: 1};
  A._Record_1_title.prototype = {$recipe: "+title(1)", $shape: 2};
  A._Record_2.prototype = {$recipe: "+(1,2)", $shape: 3};
  A._Record_2_size_src.prototype = {$recipe: "+size,src(1,2)", $shape: 4};
  A._Record_4_initialCount_onChange_subtitle_title.prototype = {$recipe: "+initialCount,onChange,subtitle,title(1,2,3,4)", $shape: 5};
  ...
  A._Record2.prototype = {
    ...
    _equalFields$1(other) {
      ...
      return J.$eq$(this._0, other._0) && J.$eq$(this._1, other._1);
    },
    $eq(_, other) {
      if (other == null)
        return false;
  ...
  A.$Avatar_closure.prototype = {
    call$0() {
      return A._functionToJS1(new A.$Avatar_closure_wrapper());
    },
    $signature: 0
  };
  ...
  A.registerAvatar_closure0.prototype = {
    call$1(p) {
      return A._Avatar_toJS(type$.Record_2_int_size_and_String_src._as(p));
    },
    $signature: 2
  };
  A.registerAvatar_closure.prototype = {
    call$1(js) {
      return A._Avatar_fromJS(A._asJSObject(js));
    },
    $signature: 13
  };
  A.$Badge_closure.prototype = {
    call$0() {
      return A._functionToJS1(new A.$Badge_closure_wrapper());
    },
    $signature: 0
  };
  ...
  A.registerBadge_closure0.prototype = {
    call$1(p) {
      return A._Badge_toJS(type$.Record_1_String_label._as(p));
    },
    $signature: 2
  };
  A.registerBadge_closure.prototype = {
    call$1(js) {
      return A._Badge_fromJS(A._asJSObject(js));
    },
    $signature: 14
  };
  A.Counter_closure.prototype = {
    call$0() {
      this._box_0.setOther.call$1(true);
    },
    $signature: 15
  };
  A._Counter_toJS_closure.prototype = {
    call$1(a0) {
      A._asInt(a0);
      this.props._values[1].call$1(a0);
    },
    $signature: 4
  };
  A._Counter_fromJS_closure.prototype = {
    call$1(a0) {
      var t1, _raw;
      A._asInt(a0);
      t1 = type$.nullable_Object;
      _raw = A.JSObjectUnsafeUtilExtension_getProperty(this.js, A.StringToJSString_get_toJS("onChange"), t1);
      if (_raw == null || A.NullableUndefineableJSAnyExtension_get_isUndefined(_raw))
        return null;
      A._callMethodUnchecked2(type$.JavaScriptFunction._as(_raw), "call", null, A.NumToJSExtension_get_toJS(a0), t1);
    },
    $signature: 4
  };
  A.$Counter_closure.prototype = {
    call$0() {
      return A._functionToJS1(new A.$Counter_closure_wrapper());
    },
    $signature: 0
  };
  A.$Counter_closure_wrapper.prototype = {
    call$1(props) {
      return A.toReactJS(A.Counter(A._Counter_fromJS(A._asJSObject(props))));
    },
    $signature: 1
  };
  A.registerCounter_closure0.prototype = {
    call$1(p) {
      return A._Counter_toJS(type$.Record_4_int_initialCount_and_nullable_void_Function_int_onChange_and_nullable_String_subtitle_and_String_title._as(p));
    },
    $signature: 2
  };
  A.registerCounter_closure.prototype = {
    call$1(js) {
      return A._Counter_fromJS(A._asJSObject(js));
    },
    $signature: 16
  };
  ...
  A.JsBinding.prototype = {
    useState$1$1(initial, $T) {
      var t1, t2, jsArray;
      $T._as(initial);
      t1 = A._getPropertyTrustType(A.staticInteropGlobalContext(), "React", type$.Object);
      t2 = A.toReactJS(initial);
      t2.toString;
      jsArray = A._callMethodUnchecked1(t1, "useState", t2, type$.JSArray_nullable_Object);
      t2 = type$.nullable_Object;
      return new A._Record_2(A.fromJS(A.getProperty(jsArray, 0, t2), $T), new A.JsBinding_useState_closure(type$.JavaScriptFunction._as(A.getProperty(jsArray, 1, t2)), $T));
    },
    useEffect$2(e, deps) {
      var jsFn, t1, t2, t3,
        _s9_ = "useEffect";
      type$.void_Function._as(e);
      type$.nullable_List_nullable_Object._as(deps);
      jsFn = A._functionToJS0(e);
      t1 = type$.Object;
      t2 = type$.void;
      if (deps == null)
        A._callMethodUnchecked2(A._getPropertyTrustType(A.staticInteropGlobalContext(), "React", t1), _s9_, jsFn, null, t2);
      else {
        t3 = type$.nullable_Object;
        A._callMethodUnchecked2(A._getPropertyTrustType(A.staticInteropGlobalContext(), "React", t1), _s9_, jsFn, A.ListToJSArray_get_toJS(J.toList$0$ax(J.map$1$1$ax(deps, new A.JsBinding_useEffect_closure(), t3)), t3), t2);
      }
    }
  };
  A.JsBinding_useState_closure.prototype = {
    call$1(v) {
      var t1 = A.toReactJS(this.T._as(v));
      t1.toString;
      return A._callMethodUnchecked2(this.setter, "call", null, t1, type$.nullable_Object);
    },
    $signature() {
      return this.T._eval$1("~(0)");
    }
  };
  A.JsBinding_useEffect_closure.prototype = {
    call$1(d) {
      return A.toReactJS(d);
    },
    $signature: 5
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "convert__toReactJS$closure", "toReactJS", 5);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.WhereTypeIterator, A.FixedLengthListMixin, A._Record, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A._Cell, A.Rti, A._FunctionParameters, A._Type, A.ListBase, A.Codec, A.Converter, A.StackOverflowError, A.FormatException, A.Null, A.StringBuffer, A.ReactBinding, A.ReactRenderer, A.ReactNode, A.Entry]);
    ...
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.WhereTypeIterable, A._KeysOrValues]);
    ...
    _inheritMany(A._Record, [A._Record1, A._Record2, A._RecordN]);
    _inheritMany(A._Record1, [A._Record_1_label, A._Record_1_title]);
    _inheritMany(A._Record2, [A._Record_2, A._Record_2_size_src]);
    _inherit(A._Record_4_initialCount_onChange_subtitle_title, A._RecordN);
    _inherit(A.ConstantStringMap, A.ConstantMap);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._convertJsonToDart_walk, A.App_closure, A.$App_closure_wrapper, A.registerApp_closure0, A.registerApp_closure, A.$Avatar_closure_wrapper, A.registerAvatar_closure0, A.registerAvatar_closure, A.$Badge_closure_wrapper, A.registerBadge_closure0, A.registerBadge_closure, A._Counter_toJS_closure, A._Counter_fromJS_closure, A.$Counter_closure_wrapper, A.registerCounter_closure0, A.registerCounter_closure, A.JsBinding_useState_closure, A.JsBinding_useEffect_closure, A.JsRenderer__render__closure, A.JsRenderer__render_closure0]);
    ...
    _inheritMany(A.Closure0Args, [A.$App_closure, A.$Avatar_closure, A.$Badge_closure, A.Counter_closure, A.$Counter_closure, A.JsRenderer__render_closure]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      ReactBinding: findType("ReactBinding"),
      ReactNode: findType("ReactNode"),
      ReactRenderer: findType("ReactRenderer"),
      Record: findType("Record"),
      Record_0: findType("+()"),
      Record_1_String_label: findType("+label(String)"),
      Record_1_String_title: findType("+title(String)"),
      Record_2_int_size_and_String_src: findType("+size,src(int,String)"),
      Record_4_int_initialCount_and_nullable_void_Function_int_onChange_and_nullable_String_subtitle_and_String_title: findType("+initialCount,onChange,subtitle,title(int,~(int)?,String?,String)"),
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "$Avatar", "$get$$Avatar", () => new A.$Avatar_closure().call$0());
    _lazyFinal($, "$Badge", "$get$$Badge", () => new A.$Badge_closure().call$0());
    _lazyFinal($, "$Counter", "$get$$Counter", () => new A.$Counter_closure().call$0());
  })();
