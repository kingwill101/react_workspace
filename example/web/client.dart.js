...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    registerCounter() {
      A.ReactRegistry_register("package:react_workspace/example/lib/counter.dart#Counter", $.$get$$Counter(), new A.registerCounter_closure(), new A.registerCounter_closure0());
    },
    ...
    Avatar(props) {
      return A.Text$("{props.src}:{props.size}");
    },
    Badge(props) {
      return A.div(A._setArrayType([A.Text$(props._0)], type$.JSArray_ReactNode));
    },
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._convertJsonToDart_walk, A.$App_closure_wrapper, A.registerApp_closure0, A.registerApp_closure, A.$Avatar_closure_wrapper, A.registerAvatar_closure0, A.registerAvatar_closure, A.$Badge_closure_wrapper, A.registerBadge_closure0, A.registerBadge_closure, A._Counter_toJS_closure, A._Counter_fromJS_closure, A.$Counter_closure_wrapper, A.registerCounter_closure0, A.registerCounter_closure, A.JsBinding_useState_closure, A.JsBinding_useEffect_closure, A.JsRenderer__render__closure, A.JsRenderer__render_closure0]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["JavaScriptFunction()", "Object?(JSObject)", "JSObject(Object?)", "@(@)", "Null(int)", "Object?(Object?)", "~(String,Object?)", "Object(ReactNode)", "@(@,String)", "@(String)", "~(Object?,Object?)", "+title(String)(JSObject)", "+size,src(int,String)(JSObject)", "+label(String)(JSObject)", "~()", "+initialCount,onChange,subtitle,title(int,~(int)?,String?,String)(JSObject)", "Object()"],
