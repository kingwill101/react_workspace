...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    hasSSRContent(root) {
      return B.JSString_methods.get$isNotEmpty(J.trim$0$s(A.JSStringToString_get_toDart(A._asString(A.JSObjectUnsafeUtilExtension_getProperty(root, A.StringToJSString_get_toJS("innerHTML"), type$.nullable_Object)))));
    },
    getInitialProps() {
      var txt, t1,
    ...
    main() {
      var initialProps, root, t1, node;
      A.initReact();
      A.registerApp();
      A.registerAvatar();
      A.registerBadge();
      initialProps = A.getInitialProps();
      root = A.getRoot("app");
      t1 = A._asStringQ(initialProps.$index(0, "title"));
      node = A.App(t1 == null ? "hi" : t1);
      if (A.hasSSRContent(root))
        A.hydrate(root, node);
      else
        A.mount(root, node);
    }
  ...
  A._Record_2_size_src.prototype = {$recipe: "+size,src(1,2)", $shape: 3};
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "convert__toReactJS$closure", "toReactJS", 13);
  })();
  (function inheritance() {
    ...
    _inherit(A._Record_2_size_src, A._Record2);
    _inherit(A.ConstantStringMap, A.ConstantMap);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._convertJsonToDart_walk, A.$App_closure_wrapper, A.registerApp_closure0, A.registerApp_closure, A.$Avatar_closure_wrapper, A.registerAvatar_closure0, A.registerAvatar_closure, A.$Badge_closure_wrapper, A.registerBadge_closure0, A.registerBadge_closure, A.JsRenderer__render__closure, A.JsRenderer__render_closure0]);
    ...
    _inheritMany(A.Closure0Args, [A.$App_closure, A.$Avatar_closure, A.$Badge_closure, A.JsRenderer__render_closure]);
